...
if(isset($_POST['paymentApprove'])) {
	...
	$paymentSql = "UPDATE `payments` SET `paymentApproved` = '1' WHERE `paymentId` = '".$paymentId."'";
    ...
    <body>
		...
		<div class="container pb-5" style="padding-top:50px">
			...
			<div>
				...
				<h3 class="mb-3">Payment Records</h3>
									...
									<tr>
										...
										<td>
											<form method="post" action>
												<div class="d-flex">
													<input type="text" value="<?= $row['paymentId'] ?>" name="paymentId" hidden>
													<button class="btn btn-success btn-sm" name="paymentApprove">&#10003;</button>
													<!--<button class="btn btn-warning btn-sm" name="paymentDecline">&#10005;</button>-->
												</div>
											</form>
										</td>
									</tr>
			...
			<div>
				...
				<h3 class="mb-3">Donations Records</h3>
