...
<div id="featured-wrapper">
		<div id="featured" class="container">
			...
			<br><br>
<br><br>
				<center><h1>Welcome to TEACHER HOMEPAGE  </h1>
				<span class="byline">Please Choose to continue using the System </span> </div>
			
			<center><div class="column1"> <span>  
				<a href = "edittimetable.php"><img src="images/schedule.png" width="100" height="100" border="0">
				</a></span>
				<div class="title">
				<h5>BOOK CAMP</h5>
				</div>
				...
				<div class="column2">
				<span><a href = "editAnnouncement.php">
